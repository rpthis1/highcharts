...
myapp.controller('myctrl', ['$scope', '$window', 'ReportService', "$sce", function ($scope, $window, ReportService, $sce) {
    ...
    $scope.icons = [
        {  "value": "Gear", "label": $sce.trustAsHtml("<i class=\"fa fa-globe\"></i> New Chiller ( 4/1/12-5/1/12)")},
        { "value": "Globe", "label": $sce.trustAsHtml("<i class=\"fa fa-globe\"></i> New Boiler ( 6/1/12-7/1/12)")}
